...
describe("ProductService Tests", () => {
    ...
    describe("createProduct", () => {
        ...
        it("should throw an error when product creation fails", async () => {
            ...
            await expect(createProduct(invalidProductData)).rejects.toThrow(AppError);
        });
    });
    ...
    describe("getProductById", () => {
        ...
        it("should throw an error when product is not found", async () => {
            await expect(getProductById("invalid-id")).rejects.toThrow(AppError);
        });
    });
    ...
    describe("updateProduct", () => {
        ...
        it("should throw an error if the product is not found", async () => {
            const updatedData = { price: 19.99 };
            await expect(updateProduct("invalid-id", updatedData)).rejects.toThrow(AppError);
        });
    ...
    describe("deleteProduct", () => {
        ...
        it("should throw an error when product is not found", async () => {
            await expect(deleteProduct("invalid-id")).rejects.toThrow(AppError);
        });
    });
});
